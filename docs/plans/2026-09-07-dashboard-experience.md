...
Status: proposed screen and interaction specification, reviewed on 2026-09-07. This defines the visible outcome required by the [implementation plan](2026-09-07-dashboard-structure-clouds-and-costs.md). The illustrations use synthetic data and do not represent the running application or actual Soundpatrol costs. The current application remains unchanged.
