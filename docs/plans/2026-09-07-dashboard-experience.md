...
Status: implementation reference, reviewed on 2026-09-07. Local UI and billing adapters are implemented; source and production acceptance are tracked in the [billing runbook](2026-09-07-dashboard-billing-operations.md). This defines the visible outcome required by the [implementation plan](2026-09-07-dashboard-structure-clouds-and-costs.md). The illustrations use synthetic data and do not represent the running application or actual Soundpatrol costs. The proposals remain design references; production rollout is separate from local verification.
