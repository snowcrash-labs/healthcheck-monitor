...
export default function FindingsPage() {
  ...
  const result = usePages(() => query("/api/v1/findings", { target: dashboard.target(), severity: value("severity"), check: value("check"), resource: value("resource"), q: value("q") }), findingPage, dashboard.refreshId);
  return <>
