...
export function Notice(props: { children: string; error?: boolean }) { return <div role={props.error ? "alert" : "status"} class={`notice${props.error ? " notice-error" : ""}`}>{props.children}</div>; }
